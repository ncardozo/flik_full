...
We added the contrast between the effective resolution of each task and the time it took more explicitly to the new \fref{sec:analysis}. Then in the new \fref{sec:answers}, we use the explicit comparisons of measured time and success to provide answer to \ref{enum:usefullness}
\end{solved}
