...
\end{remark}
\begin{solved}
We extended the results section provided a deeper analysis on the results and in particular the answers to the research questions, which should provide the required insights about the the usefulness of \flik.
\end{solved}
