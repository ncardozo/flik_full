...
At the beginning of the user study each participant received an evaluation guide\footnote{The evaluation guides and the information for the replication of the study are available at: \url{https://flaglab.github.io/Flik_Experiments/}} with the instructions to set-up the \flik environment, which includes the tasks to solve.\footnote{The experiment environment, \flik, and the problems to solve are all available in a Docker distribution available through the Docker command \spy{docker pull lrodriguez22/py-flik-debugger:latest}}
