...
\begin{enumerate}[label=\textbf{RQ.\arabic*}]
  ...
  Stepping back and updating variables values during the execution are desired feature to better 
  understand the behavior of \ac{RL} agents?
  \item \label{enum:usefulness}
  \flik can be effectively used to debug \ac{RL} programs with its current features?
\end{enumerate}
