...
focus on run-time errors, in which programs compile, but present an abnormal behavior caused by 
...
program with bugs is a process of confirming that the things one believes to be true are actually true in 
