...
\flik is a console-based debugger built on top of \ac{PDB}, which in turn is built on top of the Python 
run-time as provided by the Python interpreter. A diagram of \flik's architecture is shown in 
...
and adds features 
such as colored syntax highlighting, tracking of variables' state, . The following are the three major features of \flik:
\begin{itemize}
