...
the step back commands (\spy{step_back} or \spy{back_to}) pauses the current execution an moves 
...
execution from that given point, \flik restores the saved state as the new program state. Restoring a 
