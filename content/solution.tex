...
debugger are an appropriate tool to understand their behavior. Moreover, if the debugging process 
enables developers to modify programs' state without having to stop and re-start execution, the 
evaluation of the agents' behavior is enhanced, given their intrinsic nature of continuous 
interaction with the environment. Such property allows developers to experiment 
