...
functions we restrict the history buffer to have a fixed size of 100 frames (in our current setting, 
although this parameter is configurable). As a consequence, the buffer keeps the 100 most recent 
...
memory used by the program. However, the memory increase is constant and will not go over 100 
